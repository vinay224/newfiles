...
<body>
    <form id="form1" method="post" runat="server">
                                                                                <asp:TextBox runat="server" placeholder="Note" TextMode="MultiLine" class="form-control" ID="txtNotes" MaxLength="10" />
        <div id="box" style="display: none;">
            <p>
                Your file is creating now...
            </p>
            <iframe id="iframeExportXls" src="" marginwidth="2" marginheight="2" frameborder="1"
                style="border-width: 2px; border-color: #333; background: #FFF; border-style: solid;"></iframe>
            <br />
            <br />
        ...
        <asp:Button Text="Process" runat="server" OnClick="Unnamed1_Click" />
    </form>
